...
**v 0.1.0.0 is actively being developed and is slated for release in mid October with disassembly support, register support and numerous bug fixes. Please see `CHANGELOG.md` for additional information.**
